...
function UpdateAccountComponent() {
  ...
  useEffect(() => {
    axios.get(apiUrl+'users/'+userId).then(function (response:any) {
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-body">
              ...
              {formError === true ? <p className="bg-error">Unable to update</p> : ''}
              {formSubmitted === true ?
                <p className="bg-success">Updated successfully!!!</p>
                :
